    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessage.show("Something went wrong in registration", { cssClass: 'alert-danger', timeout: 3000 });
...
var ValidateService = /** @class */ (function () {
    ...
    ValidateService.prototype.validateEamil = function (email) {
...
module.exports = __webpack_require__(/*! /Users/justin/Desktop/Senior Project/uspace/angular-src/src/main.ts */"./src/main.ts");
